...
$result = mysqli_query($conn,"SELECT * FROM employee_salary_details");
?>
                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Employee Salary Table</h3>
                                </div>
                            </div>
                        </div>
...
<tr class="<?php if(isset($classname)) echo $classname;?>">
    ...
    <td><a href="employee_salary_update.php?id=<?php echo $row["id"]; ?>"><input type="submit" value="Update" class="btn-info" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a>

        <a href="employee_salary_delete.php?id=<?php echo $row["id"]; ?>"><input type="submit" class="btn-danger" value="Delete" style="border-radius: 5px;padding-left: 15px;padding-right: 15px;"></a></td>
                    ...
                    ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="inputEmployeesalarydate" name="salary_date">
                                        </div>
                                    </div>
